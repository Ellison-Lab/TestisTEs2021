...
```{r, fig.dim=c(10,10), out.height="4in", out.width="7in", align="center", fig.align='center'}
read_rds("~/work/TestisTEs2021/results/figs/arriba_total_rna_fusions/arriba_total_rna_fusions.ggp.rds")
```

*Supplementary Figure 9. Detected fusions between TEP-TEs and Y-linked genes* 
Fusions between TEP-TEs and Y-linked genes detected by the Arriba fusion caller in 2 or more *w1118* testis total RNA-seq replicates. Y-axis shows the percentage of reads that align to the breakpoint that support the fusion call (split reads and discordant pairs).
